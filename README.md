...
`TypeScript` · `Node.js` · `Flutter` · `PHP` · `Laravel`

**Data & APIs**
`PostgreSQL` · `MySQL` · `REST APIs` · `Prisma`

**Engineering & Infrastructure**
`Docker` · `CI/CD` · `Testing` · `Cloud` · `Git` · `Linux`
...
Previously worked on **commercial software and client projects** across:
...
[LinkedIn](https://www.linkedin.com/in/asheftajwaramin/) · [Portfolio](https://ashef.devomac.com/)
